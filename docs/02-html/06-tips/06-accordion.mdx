...
Now, all the modern browsers are supporting `<details>` and `<summary>` tags. It's able to implement accordion functions and good for accessibility. Please check how to implement to accordion by using those tags.
