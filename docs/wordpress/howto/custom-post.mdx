...
If you need to implement same layout to custom post type archive and cust om taxonomy archive, please prepare another template file and import from the above template file.
