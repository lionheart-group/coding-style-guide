...
Returns the [Application::displayTemplate](./displaytemplate) result into string after including the assigned variables in controller class that can be use in template file.
...
After assigning arguments for template, run the [Application::fetchTemplate](./fetchtemplate) method.