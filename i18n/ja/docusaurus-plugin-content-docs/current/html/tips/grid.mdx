...
Gridレイアウトはここで紹介した機能以外にも沢山の設定項目があります。もし詳しい情報が知りたい場合は、[MDNにてGridレイアウトの解説がなされています](https://developer.mozilla.org/ja/docs/Web/CSS/CSS_Grid_Layout/Basic_Concepts_of_Grid_Layout)ので、そちらから確認が可能です。
