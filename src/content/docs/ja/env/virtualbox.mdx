...
M1 mac では VirtualBox が動作しませんので、[Docker](/docs/env/docker)による環境構築をお願いします。
...
2. macOS の中の"64-bit"のリンクをクリックしてダウンロードします。

**Homebrew と Git**

[Git の説明ページ](/docs/env/git)を確認してください。
...
[GitHub](https://github.com/sushat4692/VagrantAnsible)に Vagrant 環境の設定ファイルテンプレートが存在しています。
